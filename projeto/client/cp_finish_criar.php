...
if(isset($_SESSION['created_element'])&& $_SESSION['created_element']!="") {

    $element=$_SESSION['created_element'];
}
...
<a href="index.html" class="ps-2">
    ...
    <div class="lab">
        <div class="row">
        <div class="lab_criar_final text-center">
            <p class="text-dark text-center fs-6 lab_nome_elemento pt-2"><?=$element?></p>
            <img class="pb-3" src="assets/lab//icons_elementos/<?=$element?>.svg">
    </div> 
        </div>
    </div>
</body>
