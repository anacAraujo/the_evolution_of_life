...
if(isset($_SESSION['decompose_item']) && $_SESSION['decompose_item'] !="") {

    //VOLTA PARA LAB
    header("Location:../../client/lab.php?action=decompose");
}

else {

    //MANDA PRO SESSION PARA DAR PARA ESCREVER O ITEM
    $_SESSION['decompose_item']=$id_item;
