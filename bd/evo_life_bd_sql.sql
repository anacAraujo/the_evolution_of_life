...
-- -----------------------------------------------------
-- Schema deca_23_bdtss_68
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema deca_23_bdtss_68
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `deca_23_bdtss_68` DEFAULT CHARACTER SET utf8 ;
USE `deca_23_bdtss_68` ;

-- -----------------------------------------------------
-- Table `deca_23_bdtss_68`.`avatars`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `deca_23_bdtss_68`.`avatars` (
...
-- -----------------------------------------------------
-- Table `deca_23_bdtss_68`.`profiles`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `deca_23_bdtss_68`.`profiles` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `deca_23_bdtss_68`.`users`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `deca_23_bdtss_68`.`users` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_users_avatars`
    ...
    REFERENCES `deca_23_bdtss_68`.`avatars` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_users_profiles1`
    FOREIGN KEY (`profiles_id`)
    REFERENCES `deca_23_bdtss_68`.`profiles` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `deca_23_bdtss_68`.`items`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `deca_23_bdtss_68`.`items` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `deca_23_bdtss_68`.`microorganism_settings`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `deca_23_bdtss_68`.`microorganism_settings` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `deca_23_bdtss_68`.`planets`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `deca_23_bdtss_68`.`planets` (
  ...
  CONSTRAINT `fk_planets_users1`
    FOREIGN KEY (`user_id`)
    REFERENCES `deca_23_bdtss_68`.`users` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_planets_microorganism_settings1`
    FOREIGN KEY (`id_settings`)
    REFERENCES `deca_23_bdtss_68`.`microorganism_settings` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `deca_23_bdtss_68`.`planets_items_inventory`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `deca_23_bdtss_68`.`planets_items_inventory` (
  ...
  CONSTRAINT `fk_planets_has_items_items1`
    FOREIGN KEY (`item_id`)
    REFERENCES `deca_23_bdtss_68`.`items` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_planets_items_inventory_planets1`
    FOREIGN KEY (`planets_user_id`)
    REFERENCES `deca_23_bdtss_68`.`planets` (`user_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `deca_23_bdtss_68`.`formula_location`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `deca_23_bdtss_68`.`formula_location` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC)   ,
...
-- -----------------------------------------------------
-- Table `deca_23_bdtss_68`.`market_offers`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `deca_23_bdtss_68`.`market_offers` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `deca_23_bdtss_68`.`formulas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `deca_23_bdtss_68`.`formulas` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_formula_itens_formula_location1`
    ...
    REFERENCES `deca_23_bdtss_68`.`formula_location` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `deca_23_bdtss_68`.`formula_itens`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `deca_23_bdtss_68`.`formula_itens` (
  ...
  CONSTRAINT `fk_items_has_formula_itens_formula_itens1`
    ...
    REFERENCES `deca_23_bdtss_68`.`formulas` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `deca_23_bdtss_68`.`land`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `deca_23_bdtss_68`.`land` (
  `id` INT NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `deca_23_bdtss_68`.`planets_land_items`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `deca_23_bdtss_68`.`planets_land_items` (
  `item_id` INT NOT NULL,
  `user_id` INT NOT NULL,
  ...
  CONSTRAINT `fk_planets_items_inventory_has_land_planets_items_inventory1`
    ...
    REFERENCES `deca_23_bdtss_68`.`planets_items_inventory` (`item_id` , `planets_user_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_planets_items_inventory_has_land_land1`
    FOREIGN KEY (`land_id`)
    REFERENCES `deca_23_bdtss_68`.`land` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `deca_23_bdtss_68`.`microorganism_usage`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `deca_23_bdtss_68`.`microorganism_usage` (
  ...
  CONSTRAINT `fk_microorganism_usage_planets_land_items1`
    ...
    REFERENCES `deca_23_bdtss_68`.`planets_land_items` (`item_id` , `user_id` , `land_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `deca_23_bdtss_68`.`used_formulas_planet`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `deca_23_bdtss_68`.`used_formulas_planet` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `planets_user_id` INT NOT NULL,
  `formula_id` INT NOT NULL,
  `date` DATETIME NOT NULL DEFAULT now(),
